...
\acresetall          % Abkürzungen für den Haupttext zurücksetzen (Abstract hat sie verbraucht)
\acused{CI}\acused{CICD}  % CI und CI/CD absichtlich nicht ausschreiben
\input{includes/caps/1.tex}
\input{includes/caps/2.tex}
\input{includes/caps/3.tex}
\input{includes/caps/4.tex}
\input{includes/caps/5.tex}
\input{includes/caps/6.tex}

\input{includes/caps/7.tex}

\input{includes/caps/8.tex}
