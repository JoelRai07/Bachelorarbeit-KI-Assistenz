...
\usepackage{float}
\usepackage{footnote}
%\makesavenoteenv{figure} % von mir hinzugefügt – deaktiviert wegen Konflikt mit [H] vom float-Paket
...
\lstset{numbers=left,numberstyle=\tiny,numbersep=5pt,texcl=true,basicstyle=\ttfamily\scriptsize}
...
\lstdefinelanguage{JavaScript}{
  keywords={const, let, var, function, return, export, import, from, if, else, for, while, switch, case, break, continue, default, new, class, extends, implements, interface, type, async, await, try, catch, finally, throw, true, false, null, undefined},
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]",
...
\lstdefinelanguage{TypeScript}{
  language=JavaScript,
  morekeywords={readonly, public, private, protected, abstract, declare, enum, keyof, namespace, never, unknown, type, interface, implements, as}
}
...
\usepackage{enumitem}       % key-value Optionen fuer Listen (z.B. leftmargin=*)
...
\usepackage[hypertexnames=false]{hyperref}       % URL-Formatierung, klickbare Verweise %hidelinks
...
% Fallback-Symbol für Tabellen mit nicht-erfüllten Kriterien
\providecommand{\xmark}{\texttimes}
...
\hyphenation{Rich-Client-Web-an-wen-dun-gen Play-wright-Tests Play-wright-In-ter-ak-tions-da-ten}
\usepackage{url}
\usepackage{xurl}
