...
\end{tikzpicture}
\caption[Taxonomie der Barrierefreiheitsverstöße]{Taxonomie der Barrierefreiheitsverstöße nach Fathallah et al. mit Beispielen und Erkennungscharakteristik je Kategorie.\protect\footnotemark}
\label{fig:taxonomie_verstoesse}
\end{figure}
\footcitetext[Eigene Darstellung in Anlehnung an][]{fathallah_accessguru_2025}
