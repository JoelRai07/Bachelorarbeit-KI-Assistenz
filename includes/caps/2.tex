...
\begin{itemize}
    ...
    können.\footcites[Vgl.][S. 3]{touvron2023llama2}
    \item Sie können große Mengen an Text analysieren und 
    strukturieren.\footcite[Vgl.][S. 298]{bassi_assessment_2025}
...
Dabei kombiniert RAG ein Sprachmodell mit einem Retrieval-Mechanismus,
...
werden als Ausblick in Kapitel \ref{Limits} und \ref{Ausblick}
aufgegriffen.
