...
\begin{enumerate}
    \item \textbf{\ac{JSX} und TypeScript} verarbeiten können (\ac{FA}-03)
    \item \textbf{Strukturierte Ausgaben} in einem vorgegebenen Format erzeugen (\ac{FA}-05, \ac{NFA}-04)
    \item Innerhalb eines \textbf{Kontextfensters von mindestens 8.192 Tokens} arbeiten (\ac{FA}-04)
    \item \textbf{Auf \ac{CPU}-basierten Systemen} mit akzeptabler Latenz betreibbar sein, was die Modellgröße auf ca. 7--32 Milliarden Parameter begrenzt (\ac{NFA}-02)
\end{enumerate}
