...
\begin{enumerate}
  ...
  % KÜRZUNG: Schritte 4 und 5 von je einem Absatz auf je einen Satz komprimiert –
  % technische Details stehen vollständig im Anhang-Prompt.
...
Jedes Finding wird in ein kompaktes Textformat serialisiert, das die wesentlichen Informationen auf wenige Zeilen komprimiert. Beschreibungen werden auf 300~Zeichen und Code-Snippets auf 20~Zeilen begrenzt, um den Token-Verbrauch je Finding vorhersagbar zu halten. Das vollständige Serialisierungsformat ist im System-Prompt-Beispiel in 
...
% KÜRZUNG: Suiteabhängige num_predict-Werte in Fußnote verschoben, da Implementierungsdetail.
...
Ein vollständiger Durchlauf auf der test-12-Suite erzeugt stabil Findings aus allen vier Quellen (axe: 4, Playwright: 2, grep: 6) sowie einen modellabhängigen Beitrag des \ac{LLM}-Detektors. Die detaillierte Auswertung mit Recall-Matrix, Rohdaten und Modellvergleich ist in Kapitel~\ref{kap:7} dokumentiert.