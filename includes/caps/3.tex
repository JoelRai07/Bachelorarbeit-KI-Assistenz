...
Die Recherche orientierte sich am strukturierten Vorgehen nach Webster und Watson:\footcite[Vgl.][]{WebsterWatson2002} Einem keyword-basierten Einstieg folgte ein Vorwärts- und Rückwärts-Snowballing entlang der Literaturlisten besonders einschlägiger Kernwerke. Durchsucht wurden ACM Digital Library, IEEE Xplore, ScienceDirect und arXiv. Die eingesetzten Suchstrings umfassten: \textit{\glqq web accessibility\grqq}, \textit{\glqq LLM accessibility\grqq}, \textit{\glqq accessibility violation detection\grqq}, \textit{\glqq axe-core accessibility\grqq}, \textit{\glqq WCAG automated testing\grqq} sowie \textit{\glqq screen reader artificial intelligence\grqq}.
...
Alternative Ansätze wie Action Research oder kontrollierte Experimente wurden verworfen: Action Research setzt eine längerfristige Praktikerzusammenarbeit voraus, während kontrollierte Experimente eine Stichprobenbasis erfordern, die im Verwaltungskontext nicht verfügbar ist.\footcites[Vgl.][S. 1--2]{baskerville1999ar}[][S. 239--335]{baskerville2004ar}
