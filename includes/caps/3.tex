...
Alternative Ansätze wie Action Research oder kontrollierte Experimente wurden verworfen, da beide entweder eine mehrjährige Praktikerzusammenarbeit oder eine für den Verwaltungskontext nicht verfügbare Stichprobenbasis voraussetzen.\footcites[Vgl.][S. 1--2]{baskerville1999ar}[Vgl.][S. 239--335]{baskerville2004ar}
...
\hline
\end{tabular}
\caption{Zuordnung der DSRM-Phasen zu den Kapiteln der Arbeit. Die Zuordnung folgt den inhaltlichen Schwerpunkten der Kapitel; Kommunikation erfolgt dabei über die Gesamtarbeit und wird in Kapitel~\ref{kap:8} gebündelt.}
