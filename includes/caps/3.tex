...
\begin{enumerate}
    ...
    \item \textbf{\ac{BWEC}-Feldtest:} Die Pipeline wird ergänzend auf dem realen \ac{BWEC}-Untersuchungs\-objekt eingesetzt, um Systemstabilität und qualitative Plausibilität unter realen Bedingungen zu prüfen.\footcites[Vgl.][]{axe}[Vgl.][]{kodithuwakku_assessing_2025}
\end{enumerate}
